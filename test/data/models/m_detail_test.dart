...
void main() {
  ...
  group('to entity', () {
    test(
      'should be a subclass of Detail entity',
      () async {
        final result = mDetail.toEntity();
    ...
    test(
      ...
      () async {
        final Map<String, dynamic> jsonMap = json.decode(
          readJson('helper/dummy_data/dummy_detail.json'),
        );
        final result = MMealsDetail.fromJson(jsonMap);
        expect(result.meals![0], equals(mDetail));
      },
    );
  });
